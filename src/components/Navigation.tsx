  ...
  return (
    <div className='z-50 fixed scrolling h-[80px] w-[100%] text-[#fff]'>
      <div className='relative h-[100%]'>
        <div className='logo animate__animated animate__fadeInDown absolute animate__repeat-1 w-[80px] h-[100px] top-0 bg-black ml-[50px] rounded-b-lg flex items-end pb-3'>
          <div className='w-[100%] justify-center flex'>
            <Image src={logo} alt='' width={50} className='logo'></Image>
          </div>
        </div>
        <div className='menu animate__animated animate__fadeIn ml-[200px] gap-14 flex items-center h-full text-[20px]'>
